...
public class FeedbackService {
    ...
    public ResponseEntity<String> createFeedback(FeedbackDTO feedbackDTO, User currentUser){
        Optional<Event> eventOptional = eventRepository.findById(feedbackDTO.getEventId());
